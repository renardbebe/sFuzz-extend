...
namespace fuzzer {
  ...
  class TargetExecutive {
    ...
    public:
      ...
      TargetContainerResult exec(bytes data, const tuple<unordered_set<uint64_t>, unordered_set<uint64_t>> &validJumpis, vector<pair<uint64_t, Instruction>> &instructions);
